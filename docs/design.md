...
How Ocean Game actually works: the update order, the wave model, where the
board gets its speed, and the measurements behind each tuned number. For
installing, running and deploying the game, see the [README](../README.md).
